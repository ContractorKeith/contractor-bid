...
def cb_track_add(
    ...
    id: Annotated[str, Field(description="Optional explicit bid id/slug.")] = "",
    name: Annotated[str, Field(description="Project name when not using a project folder.")] = "",
    ...
    profile: Annotated[str, Field(description="Scope profile id.")] = "",
